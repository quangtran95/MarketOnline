...
import com.quang.spring.demo.filter.CorsFilter;
import com.quang.spring.demo.filter.JWTAuthenticationFilter;
import com.quang.spring.demo.filter.JWTLoginFilter;
...
//      mngConfig.withUser(u2);
   ...
   @Bean
   public ProjectObjectMapper mapper(){
      return new ProjectObjectMapper();
   }
}
